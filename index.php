...
<head>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">
	...
	<style type="text/css">
		...
		body {font-family: Helvetica, arial; font-size: 10px; margin: 10px 0px 0px 0px; padding: 0px;}
...
<div class="jumbotron text-center">
  ...
  <div class="text-left">
    <p>
        Thank you for visiting Family Worship Center Church! As our guest, 
        we are pleased to offer free wireless internet access.
    </p> 
    <p>
  ...
  <form class="form-group" action="authenticate.php" method="post">
    ...
    <div>
        <button type="submit" class="btn btn-success btn-md btn-block">Accept and Connect</button>
       <br/>
        <div class="terms">
